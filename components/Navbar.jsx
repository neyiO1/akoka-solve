    ...
    >
      <div className="container" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", height: "80px" }}>
        ...
        <div style={{ display: "flex", gap: "24px", alignItems: "center" }}>
          ...
          <a href="mailto:partner@akokasolve.com" style={{ textDecoration: "none" }}>
            <button className="btn-primary" style={{ padding: "0.5rem 1rem", fontSize: "0.875rem", cursor: "pointer" }}>Join Platform</button>
          </a>
        </div>
      </div>
    </motion.header>
